...
set /a ngayon=%time:~6,2% + (%time:~3,2% * 60) + (%time:~0,2% * 3600)
set /a lumipas=%ngayon% - %simula%
if %lumipas% LSS %tagal% goto loop1
cls
...
echo.                                'ccxx;.',:ccc;.                           
echo.                                .;:ld:'';llccol;;,;:,.                       
echo.                                 .;col:cdkdc:ccc:;:cl.                        
echo.                                  'ccdxxOOdoc....,,.                          
echo.                                  .;:ododkOOx:                           
echo.                                  .:,,,,,:oxOOo,                            
echo.                        ..        'c;:cc:,,;cdkko'                         
echo.                      'ldxl,......;:;cooooc;;;cdkd:.                 
echo.                     ;olodolcccloxdc;cllo:..',;:oxd'                   
echo.                   .clloc,,:c:;;:loc:clld;   ,l;lxd,                    
echo.                   .;,''.  .....'.',;:cl:.   'c;cdd,                  
echo.                                     .....     'l;:lo'                   
echo.                                               .;:;:l'                   
echo.                                                .:;:l:.                
...
echo.                                              .;';:oOOdooloddl.                   
echo.                                          :dxxl::;'',coxOOx:                           
echo.                                        .looodolc;,'':lloxkx:.                             
echo.                                       .coooc,,,',c:,;cc:clol.                           
echo.                                        ';;'     .:c;;cl:,'.                                  
echo.                                                ':cccll:.                                    
echo.                                               'l:;:cll'                                 
echo.                                               ;c;;:co;                                 
...
echo.                                                        ':,,::lc:lk00x;.                       
echo.                                           .::cc,...   .::,;::cl:;:cdkko.                      
echo.                                          ,cddxollll:;lxd:,;:clc'',;:cdd,                      
echo.                                        .:oc:,;lc:;;:ccodl::cco'   .:cxd'                      
echo.                                        ,d:.. ......'',;;::ccl;    .;:dd'                      
echo.                                         .             ..;,,,;.    ':;co;                      
echo.                                                                   .:::od,                     
echo.                                                                    'c:ox;                     
...
echo.                                                                     ..        'c;:cc:,,;cdkko'
echo.                                                                   'ldxl,......;:;cooooc;;;cdkd
echo.                                                                  ;olodolcccloxdc;cllo:..',;:ox
echo.                                                                .clloc,,:c:;;:loc:clld;   ,l;lx
echo.                                                                .;,''.  .....'.',;:cl:.   'c;cd
echo.                                                                                  .....     'l;
echo.                                                                                            .;:
echo.                                                                                             .:
...
set /a ngayon=%time:~6,2% + (%time:~3,2% * 60) + (%time:~0,2% * 3600)
set /a lumipas=%ngayon% - %simula%
if %lumipas% LSS %tagal% goto MAIN
cls
